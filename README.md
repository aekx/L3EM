...
The official PyTorch implementation of the paper "Towards Emotion-enriched Text-to-Motion Generation via LLM-guided Limb-level Emotion Manipulating"[VIIST](https://dl.acm.org/doi/pdf/10.1145/3664647.3681487) in ACM MM 2024.
